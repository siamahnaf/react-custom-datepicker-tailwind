    ...
    return (
        <DatepickerContext.Provider value={contextValues}>
            <div
                ...
                ref={containerRef}
            >
                <Input setContextRef={setInputRef} customInput={customInput} />
                ...
                >
                    ...
                    <div className="mt-2.5 shadow-sm border border-gray-300 px-1 py-0.5 bg-white dark:bg-slate-800 dark:text-white dark:border-slate-600 rounded-lg">
                        <div className="flex flex-col lg:flex-row py-2">
                            ...
                            <div
                                className={`flex items-stretch flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-1.5 ${showShortcuts ? "md:pl-2" : "md:pl-1"
                                    } pr-2 lg:pr-1`}
                            >
                                <Calendar
                                    date={firstDate}
